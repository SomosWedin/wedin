          ...
          <div className="flex flex-col gap-6 items-center pb-10 w-full border-b border-gray-200 sm:flex-row">
            <div className="flex flex-col gap-2 w-full sm:w-1/2">
              ...
              <p className="text-xs text-textTertiary">
                Tus invitados las verán en un cuadrado (1:1), tanto en el
                celular como en la computadora, así que te recomendamos fotos de
                al menos 1200 × 1200 px.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-6 items-center w-full sm:flex-row">
            <div className="flex flex-col gap-2 w-full sm:w-1/2">
              ...
              <p className="text-textTertiary text-sm">
                Escribe un mensaje de bienvenida para tus invitados. Este
                mensaje se va a visualizar en la página principal de tu lista de
                regalos (hasta 255 caracteres).
              </p>
            </div>
