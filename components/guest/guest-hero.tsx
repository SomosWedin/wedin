...
export default function GuestHero({ event }: GuestHeroProps) {
  ...
  return (
    <div className="bg-gray-50">
      <section className="grid grid-cols-1 items-center mx-auto max-w-7xl lg:grid-cols-2">
        <div className="w-full aspect-[3/4]">
          <GuestImageCarousel images={event.images} />
        </div>

        <div className="flex flex-col gap-4 sm:gap-8 px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
          {dateLabel && (
